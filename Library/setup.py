...
setup(
    name='wepred',  # Your package will have this name
    packages=['wepred'],  # Name the package again
    ...
    author='Manas Pasarkar',  # Your name
    author_email='impasarkarmanas@gmail.com.com',  # Your email
